...
argocd app create apps --dest-namespace default --dest-server https://kubernetes.default.svc --repo https://github.com/bobmaertz/home-ops.git --path kubernetes/orion/apps
